...
@section('content')
   ...
   <iframe style="width:100%;height:80vh;border:0;" src="{{secure_asset($edit->url)}}" frameborder="0"></iframe>
   @elseif(_field($edit,'extension')=='docx' || _field($edit,'extension')=='doc')
   <iframe style="width:100%;height:80vh;border:0;"  src="https://docs.google.com/gview?url={{secure_asset($edit->url)}}&embedded=true"></iframe>
