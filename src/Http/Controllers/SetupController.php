...
class SetupController extends Controller
{
    ...
    {
        $data = array('username' => 'admin', 'password' => bcrypt('admin'),'host'=>request()->getHttpHost(), 'email' => 'admin@email.com', 'status' => 'Aktif', 'slug' => 'admin-web', 'name' => 'Admin Web', 'url' => 'author/admin-web', 'photo' => null, 'level' => 'admin');
